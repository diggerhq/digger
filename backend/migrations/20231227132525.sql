...
CREATE INDEX "idx_digger_job_parent_links_deleted_at" ON "public"."digger_job_parent_links" (
    "deleted_at"
);
...
CREATE INDEX "idx_github_app_installations_deleted_at" ON "public"."github_app_installations" (
    "deleted_at"
);
...
CREATE INDEX "idx_github_apps_deleted_at" ON "public"."github_apps" (
    "deleted_at"
);
...
CREATE INDEX "idx_github_digger_job_links_deleted_at" ON "public"."github_digger_job_links" (
    "deleted_at"
);
-- Create index "idx_github_job_id" to table: "github_digger_job_links"
CREATE INDEX "idx_github_job_id" ON "public"."github_digger_job_links" (
    "github_job_id"
);
...
CREATE TABLE "public"."digger_jobs" (
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_digger_jobs_batch" FOREIGN KEY (
        "batch_id"
    ) REFERENCES "public"."digger_batches" (
        "id"
...
CREATE INDEX "idx_digger_jobs_deleted_at" ON "public"."digger_jobs" (
    "deleted_at"
);
...
CREATE UNIQUE INDEX "idx_external_source" ON "public"."organisations" (
...
CREATE INDEX "idx_organisations_deleted_at" ON "public"."organisations" (
    "deleted_at"
);
...
CREATE TABLE "public"."github_app_installation_links" (
    ...
    "status" smallint NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_github_app_installation_links_organisation" FOREIGN KEY (
        "organisation_id"
...
CREATE INDEX "idx_github_app_installation_links_deleted_at" ON "public"."github_app_installation_links" (
    "deleted_at"
);
-- Create index "idx_github_installation_org" to table: "github_app_installation_links"
CREATE INDEX "idx_github_installation_org" ON "public"."github_app_installation_links" (
    "github_installation_id", "organisation_id"
);
-- Create "users" table
...
CREATE TABLE "public"."repos" (
    ...
    "digger_config" text NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_repos_organisation" FOREIGN KEY (
        "organisation_id"
    ) REFERENCES "public"."organisations" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION
...
CREATE UNIQUE INDEX "idx_org_repo" ON "public"."repos" (
...
CREATE TABLE "public"."projects" (
    ...
    "status" bigint NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_projects_organisation" FOREIGN KEY (
        "organisation_id"
    ) REFERENCES "public"."organisations" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_projects_repo" FOREIGN KEY (
        "repo_id"
    ) REFERENCES "public"."repos" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
-- Create index "idx_project" to table: "projects"
CREATE UNIQUE INDEX "idx_project" ON "public"."projects" (
    "name", "organisation_id", "repo_id"
);
...
CREATE TABLE "public"."policies" (
    ...
    "repo_id" bigint NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_policies_created_by" FOREIGN KEY (
        "created_by_id"
    ) REFERENCES "public"."users" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_policies_organisation" FOREIGN KEY (
        "organisation_id"
    ) REFERENCES "public"."organisations" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_policies_project" FOREIGN KEY (
        "project_id"
    ) REFERENCES "public"."projects" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_policies_repo" FOREIGN KEY (
        "repo_id"
    ) REFERENCES "public"."repos" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE "public"."project_runs" (
    ...
    "output" text NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_project_runs_project" FOREIGN KEY (
        "project_id"
    ) REFERENCES "public"."projects" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION
...
CREATE INDEX "idx_project_runs_deleted_at" ON "public"."project_runs" (
    "deleted_at"
);
-- Create "tokens" table
CREATE TABLE "public"."tokens" (
    ...
    "type" text NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_tokens_organisation" FOREIGN KEY (
        "organisation_id"
    ) REFERENCES "public"."organisations" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION
