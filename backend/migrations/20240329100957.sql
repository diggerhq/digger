...
CREATE TABLE "public"."digger_runs" (
    ...
    "run_type" text NULL,
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_digger_runs_project" FOREIGN KEY (
        "project_id"
    ) REFERENCES "public"."projects" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_digger_runs_repo" FOREIGN KEY (
        "repo_id"
...
CREATE INDEX "idx_digger_runs_deleted_at" ON "public"."digger_runs" (
    "deleted_at"
);
...
CREATE TABLE "public"."digger_run_stages" (
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_digger_run_stages_digger_job_summary" FOREIGN KEY (
        "digger_job_summary_id"
    ) REFERENCES "public"."digger_job_summaries" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT "fk_digger_run_stages_run" FOREIGN KEY (
        "run_id"
    ) REFERENCES "public"."digger_runs" (
        "id"
    ) ON UPDATE NO ACTION ON DELETE NO ACTION
);
-- Create index "idx_digger_run_stage_id" to table: "digger_run_stages"
CREATE INDEX "idx_digger_run_stage_id" ON "public"."digger_run_stages" (
    "run_id"
);
-- Create index "idx_digger_run_stages_deleted_at" to table: "digger_run_stages"
CREATE INDEX "idx_digger_run_stages_deleted_at" ON "public"."digger_run_stages" (
    "deleted_at"
);
