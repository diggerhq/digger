...
CREATE TABLE "public"."digger_locks" (
    ...
    PRIMARY KEY ("id"),
    CONSTRAINT "fk_digger_locks_organisation" FOREIGN KEY (
        "organisation_id"
...
CREATE INDEX "idx_digger_locked_resource" ON "public"."digger_locks" (
    "resource"
);
-- Create index "idx_digger_locks_deleted_at" to table: "digger_locks"
CREATE INDEX "idx_digger_locks_deleted_at" ON "public"."digger_locks" (
    "deleted_at"
);
