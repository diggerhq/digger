...
func (mockReporter *MockReporter) Report(report string, reportFormatting func(report string) string) (string, error) {
	mockReporter.commands = append(mockReporter.commands, "Report")
	return "", nil
}

func (mockReporter *MockReporter) Flush() (string, error) {
	return "", nil
}
