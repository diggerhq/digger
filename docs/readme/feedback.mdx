...
1. Utpal Nadiger - terraform file for the initial configuration to setup S3 and Dynamo DB for [state management](https://github.com/diggerhq/digger/issues/206)
