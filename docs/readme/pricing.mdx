...
1. **Do you separate OSS from Community, Cloud, and Enterprise plans?**
...
2. **For anyone using Digger, are all of the enterprise features in the open source codebase?** 

Yes

3. **If you pay for digger, what are you actually paying for, since you ask users to bring their own compute, and their own state?**
...
4. **How is a “user” defined for Digger Cloud?**
