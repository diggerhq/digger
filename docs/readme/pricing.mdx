...
| -------------------------------- | ---------------------------------- |---------------------------  |
| License        | Apache Licensed                    | EE licensed - [Talk to us](https://calendly.com/diggerdev/diggerdemo)    |
| Unlimited Resources              | ✅ | ✅ |
| Private Runners                  | ✅ | ✅ |
| Dependencies                     | ✅ | ✅ |
| Plan Storage                     | ✅ | ✅ |
...
Digger currently has no paid middle tier. You could use the self managed free tool OR the [GitHub App](https://dashboard.digger.dev) for free. 
...
**Which parts of Digger are Open Source?**
...
For Digger Enterprise, users pay for Audit Log Retention, SAML, SSO & SCIM, Private VCS support (Github, Gitlab and Bitbucket), Compliance Frameworks and Enterprise Support. Book a [demo](https://calendly.com/diggerdev/diggerdemo) here if you’re interested.
