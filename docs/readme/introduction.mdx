...
Digger spins up jobs in your existing CI instead of duplicating it. This is:
- More scalable, because the on-demand compute infrastructure of your CI is reused
