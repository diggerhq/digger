...
1. Use the following template. It will create the Digger + PostgreSQL services and prepopulate many of the necessary environment variables.
    ...
    [![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/VByV1N?referralCode=P06La2&utm_medium=integration&utm_source=template&utm_campaign=generic)
...
2. Set your GitHub organization name.
...
5. Create the GitHub App
    ...
    ⚠️ **IMPORTANT:** Make sure you are authenticated to the GitHub user or organization you want to use digger with and grant access for the app to the corresponding repos.

6. After creating the GitHub app, copy the provided values into their corresponding environment variables (overwriting the default `REPLACE_ME_AFTER_GH_APP_CREATION` values):
