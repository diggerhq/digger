...
<Steps>
    <Step title="Setup Auth provider">
        <Tabs>
            <Tab title="Configure publicly accessible URL">
            ...
            <Tab title="Auth0">
                ...
                In the settings tab scroll down to callback urls and add the following callback url: `http://127.0.0.1:8585/callback`
