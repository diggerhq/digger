...
<Note>
This is not the prefered way of generating terragrunt projects and we advise you to instead use the [blocks declarative](/howto/generate-projects#blocks-syntax-with-terragrunt)
