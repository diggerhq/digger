...
Similarly for the apply step you can use the $DIGGER_PLANFILE env variable to point to the plan file to apply. Note that this will only work when you have the [plan persistence](ce/features/plan-persistence)
configured. Here is an example with both plan and apply commands overriden:
