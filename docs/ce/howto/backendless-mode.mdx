...
In case of AWS, during the first run digger will create this resource for you. However in case of GCP, Azure and Alibaba Cloud you need to create it yourself and supply it as an argument.
