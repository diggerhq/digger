...
```
docker run --env-file .env -p 3000:3000 ghcr.io/diggerhq/digger_backend:v0.3.9
```
...
```
Private key in GITHUB_APP_PRIVATE_KEY has to be in one-line format, enclosed by quote marks: "-----BEGIN RSA PRIVATE KEY-----\nfirstlineofkey\nsecondlineofkey\n...\n-----END RSA PRIVATE KEY-----\n"
