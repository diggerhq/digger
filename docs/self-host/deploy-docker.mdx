...
```
docker pull digger.docker.scarf.sh/diggerhq/digger_backend:latest
```
...
```
docker run --env-file .env -p 3000:3000 digger.docker.scarf.sh/diggerhq/digger_backend:latest
```
