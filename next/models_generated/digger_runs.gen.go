...
func newDiggerRun(db *gorm.DB, opts ...gen.DOOption) diggerRun {
	...
	_diggerRun.FailureReason = field.NewString(tableName, "failure_reason")
...
func (d *diggerRun) updateTableName(table string) *diggerRun {
	...
	d.FailureReason = field.NewString(table, "failure_reason")
...
func (d *diggerRun) fillFieldMap() {
	...
	d.fieldMap["failure_reason"] = d.FailureReason
}
